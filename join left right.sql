...
-- cross join
-- ambil kolom nama_pelangan, nama_produk, qty tanpa relationship keys
...
-- right outer join
-- ambil nama_pelanggan, nama_produk, dan qty dengan right outer join
select tp.kode_pelanggan, mp.nama_pelanggan, tp.qty from tr_penjualan_dqlab as tp right outer join ms_pelanggan_dqlab as mp
on tp.kode_pelanggan = mp.kode_pelanggan;